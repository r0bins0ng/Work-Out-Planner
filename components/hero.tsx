        ...
        animate-fade-up"
            ...
            {eyebrow && (
                <a href="#" className="group">
                    <span
                        className="text-sm text-gray-600 dark:text-gray-400 font-[family-name:var(--font-geist-sans)] mx-auto px-5 py-2 
        ...
        opacity-0 md:text-xl"
            ...
            {ctaLabel && (
                <div className="flex justify-center">
                    <a
                        href={ctaHref}
                        className="mt-[-20px] z-20 inline-flex items-center justify-center 
            px-8 py-3 w-fit md:w-52 
            font-[family-name:var(--font-geist-sans)] tracking-tighter text-center text-lg 
